		...
		<Modal onClose={onClose}>
			<CustomColumn $width="100%" $alignitems="center" $justifycontent="center" $gap='2rem'>
				...
				<CustomRow $width="100%" $alignitems="center" $justifycontent="center">
					<CustomButton $width='50%' $height='auto' $padding="0.2rem 0.5rem" $backgroundColor="#473322"
						onClick={onClose}>
						<CustomFont $color='white'>취소</CustomFont>
					</CustomButton>
					<CustomButton $width='50%' $height='auto' $padding="0.2rem 0.5rem" $backgroundColor="transparent"
						$border="1px solid #473322">
